...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoredProcedureParam :  IEquatable<StoredProcedureParam>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredProcedureParam" /> class.
        /// </summary>
        ...
        public StoredProcedureParam(string Name = default(string), string Value = default(string))
        {
            this.Name = Name;
            this.Value = Value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StoredProcedureParam {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as StoredProcedureParam);
        }

        /// <summary>
        /// Returns true if StoredProcedureParam instances are equal
        /// </summary>
        /// <param name="other">Instance of StoredProcedureParam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredProcedureParam other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
